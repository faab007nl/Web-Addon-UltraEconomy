...
<head>
    ...
    <title><?php echo $lang->loggedtrades; ?> - Ultra Economy</title>
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0"><img class="img-fluid MenuHeader" src="assets/img/uecon.png"></a>
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="./trades"><i class="fas fa-book"></i><span><?php echo $lang->loggedtrades; ?></span></a></li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th><strong><?php echo $lang->leftplayer; ?></strong><br></th>
                                    <th><strong><?php echo $lang->rightplayer; ?></strong></th>
                                    <th><strong><?php echo $lang->leftinventory; ?></strong></th>
                                    <th><strong><?php echo $lang->rightinventory; ?></strong></th>
                                    <th><strong><?php echo $lang->time; ?></strong></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                    $pdoResult1 = $PDOdb->prepare("SELECT * FROM ultraeconomy_loggedtrades ORDER BY ultraeconomy_loggedtrades.key DESC");
                                    ...
                                    if($pdoExec1){
                                        while($row1 = $pdoResult1->fetch(PDO::FETCH_ASSOC)){
                                            ...
                                            $rightInventory = $data['rightInventory'];
